package com.yejh.AhoCorasickDoubleArrayTrie;
...
//    }
    ...
    private class Builder {
        ...
        private int fetch(State parent, List<Map.Entry<Integer, State>> siblings) {
            ...
            if (parent.getSuccess().entrySet() != null && !parent.getSuccess().entrySet().isEmpty()) {
        ...
        private void constructFailureStates() {
            ...
            if (this.rootState.getStates() != null && !this.rootState.getStates().isEmpty()) {
